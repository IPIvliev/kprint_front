          ...
          <div class="col-xxl-9 col-xl-8">
            <div class="panel__block">
              <div class="panel__head">
                <div class="panel__title">Категории магазина<span>{{ filteredCategories.length }}</span></div>
                <div class="panel__search d-none d-lg-block">
                  <div class="input">
                    <input
                      id="searchShopCategories"
                      type="text"
                      v-model="searchTerm"
                      placeholder="Поиск по названию или описанию"
                    >
                    <label class="panel__search-icon" for="searchShopCategories">
              ...
              <div class="panel__body">
                <div class="panel__search d-block d-lg-none">
                  <div class="input">
                    <input
                      id="searchShopCategoriesMob"
                      type="text"
                      v-model="searchTerm"
                      placeholder="Поиск по названию или описанию"
                    >
                    <label class="panel__search-icon" for="searchShopCategoriesMob">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.5 12.75C10.3995 12.75 12.75 10.3995 12.75 7.5C12.75 4.60051 10.3995 2.25 7.5 2.25C4.60051 2.25 2.25 4.60051 2.25 7.5C2.25 10.3995 4.60051 12.75 7.5 12.75Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M15.75 15.75L11.25 11.25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      </svg>
                ...
                <div class="panel__table">
                  <table>
                    <tr v-for="category in filteredCategories" :key="categoryKey(category)">
                      <td v-if="category.photo">
                        <img class="panel__table-img-model" :src="resolveMediaUrl(category.photo)" alt="">
                      </td>
                      <td v-else>
  ...
  methods: {
    ...
    async saveCategory() {
      ...
      try {
        ...
        if (this.form.parent) {
          payload.append('parent', this.form.parent)
        } else {
