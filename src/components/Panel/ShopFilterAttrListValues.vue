          ...
          <div class="col-xxl-9 col-xl-8">
            <div class="panel__block">
              <div class="panel__head">
                <div class="panel__title">Значения фильтров<span>{{ filteredValues.length }}</span></div>
                <div class="panel__search d-none d-lg-block">
                  <div class="input">
                    <input
                      id="searchFilterAttrListValues"
                      type="text"
                      v-model="searchTerm"
                      placeholder="Поиск по значению"
                    >
                    <label class="panel__search-icon" for="searchFilterAttrListValues">
                ...
                <div class="panel__add-btn">
                  <div class="btn btn--red btn--big" @click="openCreate">
                    ...
                    <div class="d-none d-md-block">Добавить значение</div>
                  </div>
                </div>
              </div>
              <div class="panel__body">
                ...
                <div class="panel__search d-block d-lg-none">
                  <div class="input">
                    <input
                      id="searchFilterAttrListValuesMob"
                      type="text"
                      v-model="searchTerm"
                      placeholder="Поиск по значению"
                    >
                    <label class="panel__search-icon" for="searchFilterAttrListValuesMob">
                      <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.5 12.75C10.3995 12.75 12.75 10.3995 12.75 7.5C12.75 4.60051 10.3995 2.25 7.5 2.25C4.60051 2.25 2.25 4.60051 2.25 7.5C2.25 10.3995 4.60051 12.75 7.5 12.75Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        <path d="M15.75 15.75L11.25 11.25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      </svg>
                ...
                <div class="panel__table">
                  <table>
                    <tr v-for="value in filteredValues" :key="valueKey(value)">
                      <td>
                        <span class="panel__table-title">{{ value.value || '—' }}</span>
                        <span class="panel__table-sn panel__table-sn--detail">
                          Фильтр: {{ filterTitle(value.filter_attr) }}
                        </span>
                      </td>
                      <td>
                        ...
                        <span class="panel__table-text">
                          <span
                            v-if="value.color"
                            :style="colorSwatchStyle(value.color)"
                            title="Цвет"
                          ></span>
                          {{ value.color || '—' }}
                        </span>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">{{ isEditing ? 'Редактировать значение' : 'Новое значение' }}</h5>
          ...
          <div class="modal-body">
            ...
            <div class="panel__formrow">
              ...
              <input type="text" v-model="form.value" class="form-control" placeholder="Значение">
            </div>
            <div class="panel__formrow">
              <label>Цвет (опционально)</label>
              <input type="text" v-model="form.color" class="form-control" placeholder="#ff0000">
            </div>
          </div>
