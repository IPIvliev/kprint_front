<template>
  <div class="main-welcome">
        <img class="pattern-main-welcome" src="../../assets/img/pattern.svg" />
        <router-link to="/shop">
...
.text-wrapper-main-item {
  position: relative;
  width: fit-content;
  font-weight: bold;
  color: rgba(34, 37, 45, 1);

}

.icons-large-main-item {
  position: relative;
  width: 24px;
  height: 24px;
}
